...
!(function($) {
  ...
  $(document).ready(function() {
	...
	fingerprintValue = client.getFingerprint(); 
...
/*	
  ...
  // components is array of {key: 'foo', value: 'component value'}
    ...
    $("#fingerprint").html(fingerprintValue);
...
*/
	...
	$("#fingerprint").html(fingerprintValue);
     ...
     //window.location.href =  ln == 'es' ? "index.htm" : "index.html"; 
     var vref =  ln == 'es' ? "index.htm" : "index.html"; 
